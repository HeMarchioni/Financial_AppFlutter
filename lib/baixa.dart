...
class Baixa extends StatelessWidget {
...
class BaixaBody extends StatefulWidget {
  const BaixaBody({Key? key}) : super(key: key);

  @override
  _BaixaBodyState createState() => _BaixaBodyState();
}
...
class _BaixaBodyState extends State<BaixaBody> {
  ...
  var url = "https://api.hgbrasil.com/finance/stock_price?format=json-cors&key=be36731f&symbol=get-low";



  void obterBaixa() async {
